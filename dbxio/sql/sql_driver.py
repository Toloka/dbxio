...
from dbxio.sql.query import QUERY_PARAMS_TYPE, BaseDatabricksQuery, ConstDatabricksQuery, log_query
from dbxio.sql.results import _FutureBaseResult, _FutureODBCResult, _FutureStatementApiResult
...
class ODBCDriver(SQLDriver):
    ...
    def _sql_to_files_impl(
        ...
        if max_concurrency > 1:
            logger.warning('Concurrent downloads of SQL results are not supported for ALL_PURPOSE clusters.')
